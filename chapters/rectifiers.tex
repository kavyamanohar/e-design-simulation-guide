...
\begin{figure}[h]
\centering
\includegraphics[width=0.8\textwidth]{BRCfilter.png}
...
\begin{figure}[h]
\centering
\includegraphics[width=0.8\textwidth]{BRLCfilter.png}
...
Select the capacitor and edit its component value to 1u and edit the component value of inductor to 15H.% as shown in Figure \ref{editvalueRes}.
...
Now we have the circuit diagram as shown in Figure \ref{BRCfilter}.
...
\begin{figure}[h]
\centering
\includegraphics[width=\textwidth, height=4cm]{BRLCfiltertransient.png}
...
\begin{figure}[h]
\centering
\includegraphics[width=\textwidth, height=4cm]{BRLCfiltersource.png}
...
\begin{figure}[h]
\centering
\includegraphics[width=12cm, height=8cm]{BRCfilterout.png}
...
\begin{figure}[h]
\centering
\includegraphics[width=12cm, height=8cm]{BRLCfilterout.png}
