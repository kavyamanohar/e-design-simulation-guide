\chapter{MOSFET CHARACTERISTICS}
...
\begin{figure}[h]
\centering
\includegraphics[width=0.8\textwidth]{MOSFETckt.png}
...
Now we have the circuit diagram as shown in Figure \ref{MOSFETckt}.
...
\begin{figure}[h]
\centering
\includegraphics[width=12cm, height=6cm]{MOSFETdrain0.png}
